						...
						<div class="tab-content">
							...
							<c:if test="${empty custName }">
								...
								<form:form action="searchCustomerName" method="post"
									id="searchCustomerName" class="searchCustomerName"
									modelAttribute="searchCustomerName">
															...
															<div class="col-md-6 inputGroupContainer">
																<div class="input-group">
																	<span class="input-group-addon"><i
																		...
																		value="<c:out value="${reading.monoReading}"/>">
																		class="form-control" type="text">
																</div>
															</div>
														</div>
															...
															<div class="col-md-6 inputGroupContainer">
																<div class="input-group">
																	<span class="input-group-addon"><i
																		...
																		value="<c:out value="${reading.colorReading}"/>"
																		class="form-control" type="text">
																</div>
															</div>
														</div>
